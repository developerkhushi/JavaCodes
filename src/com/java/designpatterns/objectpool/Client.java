...
public class Client {
    public static void main(String[] args) {
        ...
        System.out.println(nullDBConnection == null ? "DBConnection is null as POOL is full."
        ...
        System.out.println(poolManager == poolManager2 ? "Same instance of DBConnectionPoolManager"
